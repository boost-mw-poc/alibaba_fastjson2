...
```groovy
dependencies {
    implementation 'com.alibaba.fastjson2:fastjson2-extension-spring5:2.0.65'
}

or

dependencies {
    implementation 'com.alibaba.fastjson2:fastjson2-extension-spring6:2.0.65'
}
```
...
public class FastJsonWebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        converter.setFastJsonConfig(config);
        // From version 2.0.61, FastJsonHttpMessageConverter default charset is already UTF-8, no need to set manually
        // converter.setDefaultCharset(StandardCharsets.UTF_8);
